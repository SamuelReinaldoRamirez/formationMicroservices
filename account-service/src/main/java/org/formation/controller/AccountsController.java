...
//        c.setTo(account.getEmail());
//        c.setSubject("Bienvenu");
//        c.setText("ceci est un texte");
//
//        String response = notificationClient.sendSimple(c);
//
//        System.out.println("Notification is " + response);
//        logger.info("Notification is " + response);
// 
//        return account;
//    }​​​​
	...
	public Account register(@Valid @RequestBody Account account) {
		...
		courriel.setTo(account.getEmail());
		courriel.setSubject("inscription");
		courriel.setText("BVN");

		String response = notifClient.envoiCourrier(courriel);
